...
<div id="page" class="hfeed site"><div class="pbr-page-inner row-offcanvas row-offcanvas-left">
	...
	<header id="pbr-masthead" class="site-header header-fullwidth header-light <?php  if( fullhouse_fnc_theme_options('keepheader') ) : ?> keep-header<?php endif; ?>" role="banner">
