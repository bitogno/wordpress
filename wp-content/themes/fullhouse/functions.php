...
function fullhouse_fnc_scripts() {
	 ...
	 */
	if( in_array( 'dsidxpress/dsidxpress.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ){
		wp_enqueue_style( 'idx', get_template_directory_uri() . '/css/idx.css');
	}
}
