...
function fullhouse_fnc_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control('theme_color', array( 
        'label'    => esc_html__('Theme Color', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );

    $wp_customize->add_setting('sencondary_color', array( 
        'default'    => get_option('sencondary_color'),
        'type'       => 'option',
        'capability' => 'manage_options',
        'transport'  => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control('sencondary_color', array( 
        'label'    => esc_html__('Sencondary Theme Color', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );
    // // / // 
    ...
    $wp_customize->add_setting('topnav_bg', array( 
        'default'    => get_option('topnav_bg'),
        'type'       => 'option',
        'capability' => 'manage_options',
        'transport'  => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control('topnav_bg', array( 
        'label'    => esc_html__('Top Navigator Background', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );


    $wp_customize->add_setting('topnav_color', array( 
        'default'    => get_option('topnav_color'),
        'type'       => 'option',
        'capability' => 'manage_options',
        'transport'  => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control('topnav_color', array( 
        'label'    => esc_html__('Top Navigator Text Color', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );
    ...
    $wp_customize->add_control('footer_color', array( 
     ...
     $wp_customize->add_setting('copyright_bg', array( 
        'default'    => get_option('copyright_bg'),
        'type'       => 'option',
        'capability' => 'manage_options',
        'transport'  => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control('copyright_bg', array( 
        'label'    => esc_html__('Copyright Background Color', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );    

    $wp_customize->add_setting('copyright_color', array( 
        'default'    => get_option('copyright_color'),
        'type'       => 'option',
        'capability' => 'manage_options',
        'transport'  => 'postMessage',
        'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control('copyright_color', array( 
        'label'    => esc_html__('Copyright Text Color', 'fullhouse'),
        'section'  => 'colors',
        'type'      => 'color',
    ) );
