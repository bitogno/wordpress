     	...
     	<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body row">
					...
					<div class="col-sm-12">	
					<?php endif; ?>		
						<h3><?php _e('Select Your Location','fullhouse');?></h3>
						<p><em><?php _e('Select one to show all property in selected location','fullhouse'); ?></em></p>
						...
						<p class="location-bottom text-center">
							<a class="btn btn-warning btn-3d" href="<?php echo  home_url( '/' )?>?clear_location=1">
								<i class="fa fa-remove"></i>	<?php _e('Clear Location','fullhouse'); ?>
							</a>
						</p>
					</div>
