...
<div id="page" class="hfeed site"><div class="pbr-page-inner row-offcanvas row-offcanvas-left">
	...
	<!-- <div id="logoHeader"> <img id="logoHeaderImg" src="<?php echo get_stylesheet_directory_uri(); ?>/img/Domoum1.png"></div> -->
	<header id="pbr-masthead" class="site-header <?php  if( fullhouse_fnc_theme_options('keepheader') ) : ?> keep-header<?php endif; ?>" role="banner">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
