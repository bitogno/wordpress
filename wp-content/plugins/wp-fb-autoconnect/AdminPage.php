    ...
    <div class="jfb-admin_wrapper">
		...
		<h3><?php _e("Setup Instructions", 'wp-fb-autoconnect')?></h3>
            ...
            <ol>
			  ...
			  <li><?php _e("When the 'Add a New App' window pops up, click the 'basic setup' link at the bottom.", 'wp-fb-autoconnect')?></li>
			  <li><?php _e("Type in a name (i.e. the name of your site), contact e-mail, select a category, and click 'Create App.'", 'wp-fb-autoconnect')?></li>
			  ...
			  <li><?php _e("Also on the 'Settings' page, note the App ID and App Secret (you'll need them in a minute), and save changes.", 'wp-fb-autoconnect')?></li>
			  <li><?php _e("Go to the 'App Review' page and make the app public (flip the switch at the top).", 'wp-fb-autoconnect')?></li>
