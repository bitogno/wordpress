...
class OpalEstate_Shortcodes{
	...
	public static function init(){
	 	...
	 	self::$shortcodes = array(
	 		...
	 		'search_map_properties'		=> array( 'code' => 'search_map_properties', 'label' 	=> __( 'Search Map Properties', 'opallisting' ) ),
	 		'ajax_map_search'			=> array( 'code' => 'ajax_map_search', 'label' 			=> __( 'Ajax Search Map Properties', 'opallisting' ) ),
	 		'ajax_map_quick_search'	    => array( 'code' => 'ajax_map_quick_search', 'label' 			=> __( 'Ajax Search Map Properties', 'opallisting' ) ),
	 	);
