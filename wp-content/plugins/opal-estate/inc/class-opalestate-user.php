	...
	//	add_action( 'admin_init', array( __CLASS__, 'disable_profile_page' )  );
 	...
 	public static function show_message_user_profile(){
	    ...
	    <div  id="message" class="updated fade">
	        <p><?php echo sprintf( __('This user has role <strong>Opal Estate Office</strong> and click here to <a target="_blank" href="%s">update Office profile</a>'), $link ); ?></p>
	    </div>
		...
		?>
	    <div  id="message" class="updated fade">
	        <p><?php echo sprintf( __('This user has role <strong>Opal Estate Agent</strong> and click here to <a target="_blank" href="%s">update Agent profile</a>'), $link ); ?></p>
	    </div>
		<?php endif; ?>
	<?php
		endif; 
