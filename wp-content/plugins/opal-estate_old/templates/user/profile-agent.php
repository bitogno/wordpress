 	...
 	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<?php
				...
				echo cmb2_get_metabox_form( $metaboxes[OPALESTATE_AGENT_PREFIX.'front'], $post_id, array(
			...
			?>
			<?php else : ?>
			<div class="alert alert-danger"><?php _e( 'Agent edit profile form is not avariable' ); ?></div>
			<?php endif; ?>	
			</div>
	</div>	
</div>